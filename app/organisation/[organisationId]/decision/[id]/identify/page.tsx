...
import { ConditionalProfiler } from "@/components/ConditionalProfiler";
...
export default function DecisionIdentityPage() {
  ...
  const handleConditionalProfilerRender: ProfilerOnRenderCallback = (
    id,
    phase,
    actualDuration,
    baseDuration,
  ...
  return (
    <>
      <ConditionalProfiler
        id="DecisionIdentityPage"
        onRender={handleConditionalProfilerRender}
      >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="border rounded-md">
                ...
                <textarea
                  ...
                  onBlur={(e) => updateDecisionDescription(e.target.value)}
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => updateDecisionCost(value as Cost)}
              >
